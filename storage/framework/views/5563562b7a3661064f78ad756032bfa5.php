...
<?php $component = App\View\Components\Form::resolve(['action' => ''.e(route('Remetentes/Save')).'','enctype' => 'multipart/form-data'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <hr>
                <div class="row">
                    <table class="table" id="escolas" data-rota="<?php echo e(route('Remetentes/list')); ?>">
...
<?php endif; ?><?php /**PATH C:\Projetos\FRMail\resources\views/Remetentes/index.blade.php ENDPATH**/ ?>